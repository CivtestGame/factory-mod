...
local function get_smelter_active_formspec(fuel_percent, item_percent)
	return "size[8,8.5]"..
           "label[0,0;Smelter]"..
		"list[context;src;0.0,1;3,2;]"..
		"list[context;fuel;3.25,2.75;1,1;]"..
		"image[3.25,1.5;1,1;default_furnace_fire_bg.png^[lowpart:"..
		(100-fuel_percent)..":default_furnace_fire_fg.png]"..
		"image[3.25,0.5;1,1;gui_furnace_arrow_bg.png^[lowpart:"..
		(item_percent)..":gui_furnace_arrow_fg.png^[transformR270]"..
		"list[context;dst;4.5,1;3,2;]"..
...
local function get_smelter_inactive_formspec()
	return "size[8,8.5]"..
           "label[0,0;Smelter]"..
		"list[context;src;0.0,1;3,2;]"..
		"list[context;fuel;3.25,2.75;1,1;]"..
		"image[3.25,1.5;1,1;default_furnace_fire_bg.png]"..
		"image[3.25,0.5;1,1;gui_furnace_arrow_bg.png^[transformR270]"..
		"list[context;dst;4.5,1;3,2;]"..
		"list[current_player;main;0,4.25;8,1;]"..
		"list[current_player;main;0,5.5;8,3;8]"..
		"listring[context;dst]"..
...
local function can_dig(pos, player)
	...
	local inv = meta:get_inventory()
        -- TODO: drop everything when smelter broken
...
local function smelter_node_timer(pos, elapsed)
	...
	while elapsed > 0 and update do
		...
		-- Check if we have smeltable content
		local aftercooked
		cooked, aftercooked = minetest.get_craft_result({method = "smelting", items = srclist})
	...
	if fuel_totaltime ~= 0 then
		...
		formspec = get_smelter_active_formspec(fuel_percent, item_percent)
		swap_node(pos, "factory_mod:smelter_active")
		...
		formspec = get_smelter_inactive_formspec()
		swap_node(pos, "factory_mod:smelter")
		-- stop timer on the inactive furnace
		minetest.get_node_timer(pos):stop()
	end

	local infotext = "Smelter " .. active .. "\n(Item: " .. item_state ..
		"; Fuel: " .. fuel_state .. ")"
...
local smelter_fns = simplecrafting_lib.generate_multifurnace_functions("smelter", "fuel", {
      show_guides = true,
...
minetest.register_node("factory_mod:smelter", {
	...
	-- 	local meta = minetest.get_meta(pos)
	-- 	meta:set_string("formspec", get_smelter_inactive_formspec())
	-- 	local inv = meta:get_inventory()
	-- 	inv:set_size('src', 6)
	-- 	inv:set_size('fuel', 1)
	-- 	inv:set_size('dst', 6)
